...
public final class DoubleRangeConstraintTable extends Table {
    ...
    private static final String DESCR = "<p>Each row represents a single range constraint on a single double-valued "
                                        + "field within a table. There cam be only one double range constraint on a " +
                                        "field.</p>";
    ...
    static {
        ...
        F_MIN_VALUE = new Field(new FieldDef("min_value", EFieldType.DOUBLE,
                "The minimum allowed value."), EFieldRole.NOT_NULL);
        F_MAX_VALUE = new Field(new FieldDef("max_value", EFieldType.DOUBLE,
