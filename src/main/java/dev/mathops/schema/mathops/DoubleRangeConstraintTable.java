 ...
 */
public final class DoubleRangeConstraintTable extends Table {

    /** The table description (HTML). */
    private static final String DESCR = "<p>Each row represents a single range constraint on a single double-valued "
            + "field within a table. There cam be only one double range constraint on a field.</p>";
    ...
    /** The single instance. */
    public static final DoubleRangeConstraintTable INSTANCE;
    ...
    static {
        ...
        F_ALLOWED = new Field("allowed", EFieldType.INTEGER, EFieldRole.NOT_NULL,
                "A code that defines the set of allowed values: 0: All values, 1: All but NaN, 2: All but Infinities, "
                        + " 3: Finite only");
        F_MIN_VALUE = new Field("min_value", EFieldType.DOUBLE, EFieldRole.NOT_NULL,
                "The minimum allowed value.");
        F_MAX_VALUE = new Field("max_value", EFieldType.DOUBLE, EFieldRole.NOT_NULL,
        ...
        INSTANCE = new DoubleRangeConstraintTable();
    }

    /**
     * Constructs a new {@code DoubleRangeConstraintTable}.
     */
    private DoubleRangeConstraintTable() {

        super("mathops", "persistence", "double_range_constraint", DESCR, null, F_SCHEMA, F_TABLE, F_FIELD, F_ALLOWED,
